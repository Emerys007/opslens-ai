(function(React2, react) {
  ...
  hubspot.extend(({ context }) => {
    return /* @__PURE__ */ React2.createElement(NewCard, { context });
  });
  const NewCard = ({ context }) => {
    var _a, _b, _c, _d, _e, _f, _g, _h;
    const [loading, setLoading] = React2.useState(true);
    const [error, setError] = React2.useState("");
    const [payload, setPayload] = React2.useState(null);
    const recordId = String(((_a = context == null ? void 0 : context.crm) == null ? void 0 : _a.objectId) ?? "unknown");
    const objectTypeId = String(((_b = context == null ? void 0 : context.crm) == null ? void 0 : _b.objectTypeId) ?? "0-1");
