...
def upsert_portal_entitlement_from_install_session(
    ...
    *,
    ...
    # Product decision: Professional is the intended default trial tier, so a
    # plan-less install (no explicit choice carried through) also defaults to
    # "professional" for consistency. Explicit plan choices and Stripe-derived
    # plans on paid installs still win over this fallback.
