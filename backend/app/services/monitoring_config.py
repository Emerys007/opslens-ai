...
MONITORING_CATEGORY_PIPELINE_ARCHIVED = SOURCE_EVENT_PIPELINE_ARCHIVED
MONITORING_CATEGORY_PIPELINE_DELETED = SOURCE_EVENT_PIPELINE_DELETED
MONITORING_CATEGORY_PIPELINE_RENAMED = SOURCE_EVENT_PIPELINE_RENAMED
MONITORING_CATEGORY_PIPELINE_STAGE_ADDED = SOURCE_EVENT_PIPELINE_STAGE_ADDED
MONITORING_CATEGORY_PIPELINE_STAGE_REMOVED = SOURCE_EVENT_PIPELINE_STAGE_REMOVED
MONITORING_CATEGORY_PIPELINE_STAGE_RENAMED = SOURCE_EVENT_PIPELINE_STAGE_RENAMED
MONITORING_CATEGORY_PIPELINE_STAGE_REORDERED = SOURCE_EVENT_PIPELINE_STAGE_REORDERED
...
MONITORING_CATEGORY_DEFAULT_SEVERITIES: dict[str, str] = {
    ...
    MONITORING_CATEGORY_PIPELINE_ARCHIVED: SEVERITY_HIGH,
    MONITORING_CATEGORY_PIPELINE_DELETED: SEVERITY_HIGH,
    MONITORING_CATEGORY_PIPELINE_RENAMED: SEVERITY_LOW,
    MONITORING_CATEGORY_PIPELINE_STAGE_ADDED: SEVERITY_LOW,
    MONITORING_CATEGORY_PIPELINE_STAGE_REMOVED: SEVERITY_HIGH,
    MONITORING_CATEGORY_PIPELINE_STAGE_RENAMED: SEVERITY_LOW,
    MONITORING_CATEGORY_PIPELINE_STAGE_REORDERED: SEVERITY_MEDIUM,
}
